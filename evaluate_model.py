...
def parse_args():
  ...
  parser.add_argument('--bs', dest='batch_size',
                      help='batch_size',
                      default=1, type=int)
  parser.add_argument('--s_bs', dest='batch_size',
                      help='batch_size',
                      default=3, type=int)
  parser.add_argument('--t_bs', dest='batch_size',
                      help='batch_size',
                      default=3, type=int)
...
def evaluate_model(fasterRCNN,loop_count):
  ...
  if loop_count==-1:
    ...
    #imdb, roidb, ratio_list, ratio_index = combined_roidb('indoor_2007_test_mixup_s', False)
    #imdb, roidb, ratio_list, ratio_index = combined_roidb('cleanlemur_2007_test_t', False)
    imdb, roidb, ratio_list, ratio_index = combined_roidb('cleanlemur_2007_toy_test', False)
  elif loop_count==8:
    imdb, roidb, ratio_list, ratio_index = combined_roidb('indoor_2007_test_indoor_cl_all', False)
  else:
    imdb, roidb, ratio_list, ratio_index = combined_roidb('indoor_2007_test_indoor_cl_round'+str(loop_count), False)
