...
def get_resnet_backbone(backbone_name: str):
    ...
    if backbone_name in ['resnet18', 'resnet34', 'resnet50', 'resnet101', 'resnet152']:
        ...
        backbone = torch.nn.Sequential(*list(pretrained_model.children())[:-2]) #list of length 10 
        backbone.out_channels = out_channels
        
        # summary(pretrained_model, input_size=(12, 3, 512, 512), col_names=(
        #     "input_size",
        #     "output_size",
        #     "num_params",
        #     "kernel_size",
        ...
        pretrained_model  = torch.load("C:/Users/iotlab/Downloads/Lin_stuff/UnityProgram/AR_App_Bounding_Box_Demo/Run_Faster_RCNN_on_a_Server/resnet18_model_only_conv5_fine_tuned.pkl", map_location=torch.device('cpu')) 
        out_channels = 512
